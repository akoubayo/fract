...
/*   Updated: 2016/04/11 19:12:28 by daltman          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char		*ft_fillstr(char *str, unsigned int n, int size, int maj)
{
	size = size - 2;
	while (n >= 16)
	{
...
char			*ft_itoa_base_short(unsigned int n, int maj)
{
	char				*str;
	int					size;
